...
namespace HomeAPI.Backend.Tests.Providers.Weather
{
	public class OWMProviderTests
	{
		...
		#region GetCompleteWeatherAsync

		[Fact]
		public async void GetCompleteWeatherAsync_InvalidJson()
		{
			string response = "{abc}";
			...
			var result = await owmProvider.GetCompleteWeatherAsync();

			Assert.Null(result);
		}

		[Fact]
		public async void GetCompleteWeatherAsync_Successful()
		{
