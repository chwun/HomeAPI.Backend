...
namespace HomeAPI.Backend.Tests.Providers.Weather
{
	public class OWMProviderTests
	{
		...
		public void OWMProvider_Constructor()
		{
			...
			var owmProvider = new OWMProvider(clientFactory, optionsMonitor);

			Assert.NotNull(owmProvider); // dummy test
		}

		[Fact]
		public async void GetWeatherAsyncTests_InvalidJson()
		{
			string response = "{abc}";
		...
		[Fact]
		public async void GetWeatherAsyncTests_Successful()
		{
